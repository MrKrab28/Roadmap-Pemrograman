...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login | Artisan.Compass</title>
    ...
    <link href="{{ asset('assets/libs/sweetalert2/sweetalert2.min.css') }}" id="app-style" rel="stylesheet"
        type="text/css" />
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="mt-4 pt-2" action="{{ route('authenticate') }}" method="POST">
                                        ...
                                        <div class="form-floating form-floating-custom mb-4">
                                            ...
                                            <label for="input-nama">Username</label>
