            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="ecommerce-seller.html" data-key="t-seller">Seller <span class="badge rounded-pill bg-soft-danger text-danger float-end">New</span></a></li>
                        <li><a href="ecommerce-sale-details.html" data-key="t-sale-details">Sale details <span class="badge rounded-pill bg-soft-danger text-danger float-end">New</span></a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="ui-utilities.html" data-key="t-utility">Utilities <span class="badge rounded-pill bg-soft-danger text-danger float-end">New</span></a></li>
                    </ul>
                </li>
