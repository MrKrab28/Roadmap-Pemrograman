            ...
            <ul class="navbar-nav ms-auto " style="font-family: Cascadia Code; font-weight: 500;font-size: 15px;">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end bg-dark" aria-labelledby="userDropdown">
                        <li><a class="dropdown-item" href="apps-contacts-profile.html"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profile</a></li>
                        <li><a class="dropdown-item" href="auth-lock-screen.html"><i class="mdi mdi-lock font-size-16 align-middle me-1"></i> Lock screen</a>
